...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice);
      ...
      for (b = 0; b < a.responsivevoices.length; b++)
        for (c = a.responsivevoices[b], d = 0; d < c.voiceIDs.length; d++) {
          ...
          if (1 != n.fallbackvoice) {
            ...
            a.iOS12_0 && c.lang.toLowerCase() != e.toLowerCase() && c.lang.toLowerCase()
              .split("-")[0] != e.toLowerCase() && (g = null);
            if (null != g) {
              c.mappedProfile = {
                systemvoice: g,
                collectionvoice: n
    ...
    a.getSystemVoice = function(b) {
      ...
      for (var e = 0; e < a.systemvoices.length; e++)
        if (0 === a.systemvoices[e].name.localeCompare(b) || 0 === a.systemvoices[e].name.replace(new RegExp("\\s+|" + c, "g"), "")
          .replace(/ *\([^)]*\) */g, "")
          .localeCompare(d)) return a.systemvoices[e];
      return null
    };
    ...
    a.tts_speak = function(b) {
      setTimeout(function() {
          a.cancelled = !1;
          a.analytics.characterCount += b.text.toString()
            .length;
          speechSynthesis.speak(b)
        },
        .01)
    ...
    a.numToWords = function(b) {
          ...
          return function(x, t) {
            ...
            if (Symbol.iterator in Object(x)) {
              var y = [],
                ...
                H = void 0;
              try {
                for (var D = x[Symbol.iterator](), E; !(v = (E = D.next())
                  .done) && (y.push(E.value), !t || y.length !== t); v = !0);
              } catch (I) {
                C = !0, H = I
              } finally {
                try {
      ...
      return "number" === typeof b ? a.numToWords(String(b)) : "0" === b ? "zero" : h(p(3))(g)(Array.from(b))
        .map(B)
        .map(F)
        .filter(h(r)(d))
        .reverse()
