...
<%--
    ...
    html向servlet,浏览器到服务器的请求和重定向类似，都是 ”/“即服务器根路径。不包含上下文
...
<form action="some.do" method="GET">
    <button type="submit">GET请求some.do然后重定向普通页面</button>可以
</form>
<form action="/some.do" method="GET">
    <button type="submit">GET请求/some.do然后重定向普通页面</button>报错
</form>
...
<form action="test.html" method="GET"><%--http://localhost:8080/myweb/test.html?没问题--%>
    <button type="submit">GET->test.html</button>
</form>
<form action="test.html" method="POST"><%--http://localhost:8080/myweb/test.html没问题--%>
    <button type="submit">POST->test.html</button>
</form>
<form action="/test.html" method="POST"><%--报错 http://localhost:8080/test.html--%>
    <button type="submit">POST->/test.html</button>
</form>
