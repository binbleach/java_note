 ...
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", targetNamespace = "http://service.cxf.huangjiabin.com/", wsdlLocation = "http://127.0.0.1:8080/cxf/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERINTERFACESERVICE_QNAME = new QName("http://service.cxf.huangjiabin.com/", "WeatherInterfaceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/cxf/weather?wsdl");
    ...
    public WeatherInterface getWeatherInterfacePort() {
        return super.getPort(new QName("http://service.cxf.huangjiabin.com/", "WeatherInterfacePort"), WeatherInterface.class);
    }
    ...
    public WeatherInterface getWeatherInterfacePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.cxf.huangjiabin.com/", "WeatherInterfacePort"), WeatherInterface.class, features);
    }
