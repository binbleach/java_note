...
import com.bin.tools.StockTools;
...
//                .model("deepseek-v3")
    ...
    //spring ai alibaba 提供的 ReactAgent类实现
    ...
    //MemorySaver() 基于内存记忆。下面是改为基于mysql记忆
