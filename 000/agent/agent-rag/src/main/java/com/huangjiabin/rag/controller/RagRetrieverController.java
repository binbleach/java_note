...
public class RagRetrieverController implements InitializingBean {
    ...
    /*
    *   检索
    *   http://localhost:8080/rag/embedding/embed?filePath=D:/杂七杂八/毕业设计/黄家宾答辩/黄家宾-1840611023论文全.docx
    */
    @GetMapping("/query")
    ...
    /*
    *   检索并增强
    *   http://localhost:8080/rag/retriever/retrieve?query=校园公共活动场所管理现状&threshold=0.5
    */
    @GetMapping("/retrieve")
    ...
    /*
     *   检索并增强（通过advisors）
     *  http://localhost:8080/rag/retriever/retrieveAdvisor?query=校园公共活动场所管理现状
     */
