package com.huangjiabin.streamable.tools;


import com.alibaba.fastjson2.JSON;
import com.huangjiabin.streamable.entity.WeatherRequest;
import com.huangjiabin.streamable.entity.WeatherResponse;
...
public class WeatherTool {
    ...
    public String getWeather(String city) {
        log.info("===============================");
        log.info("streamable weatherTool call...");
        if (city == null) {
            return "请提供城市名称";
        }
        return switch (city) {
