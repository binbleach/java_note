...
public class KnowledgeDocumentController {
    ...
    public KnowledgeDocument uploadFile(
        ...
        DocumentUploadParam documentUploadParam = new DocumentUploadParam(file, uploadUser, title, accessibleBy, description, knowledgeBaseType, tableName);
        return documentProcessService.upload(documentUploadParam);
    }
}
