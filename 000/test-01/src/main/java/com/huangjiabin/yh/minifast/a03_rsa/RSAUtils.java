package com.huangjiabin.yh.minifast.a03_rsa;
...
public class RSAUtils {
    ...
    public static String decode(String encodeStr, String privateKey) {
        ...
        try {
            if (StringUtils.isNotBlank(encodeStr) && StringUtils.isNotBlank(privateKey)) {
                byte[] decodeHexStr = Hex.decodeHex(encodeStr.toCharArray());
                privateKey = privateKey.replaceAll(" +", "+");
                byte[] privateKeyByte = Base64Utils.decodeFromString(privateKey);
                ...
                decodeStr = URLDecoder.decode(new String(bytes, StandardCharsets.UTF_8), "utf-8");
            }
        } catch (Exception e) {
    ...
    *   解密测试
    */
    public static void testKey(String data, String key) throws InvalidKeySpecException, NoSuchAlgorithmException {
        String decodedData = RSAUtils.privateDecrypt(data, RSAUtils.getPrivateKey(key));
    ...
    *   获取密钥对
    */
    public static void getKey() throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        //质检，StandardCharsets.UTF_8
        System.out.println("\r明文大小：" + str.getBytes(StandardCharsets.UTF_8).length);
        String encodedData = RSAUtils.publicEncrypt(str, RSAUtils.getPublicKey(publicKey));
        System.out.println("密文：" + encodedData);
        String decodedData = RSAUtils.privateDecrypt(encodedData, RSAUtils.getPrivateKey(privateKey));
        System.out.println("解密后文字: " + decodedData);
        String decodeDataTFWB = RSAUtils.decode(encodedData,privateKey);
        System.out.println("TFWB解密后文字: " + decodeDataTFWB);
    }
