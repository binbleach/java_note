...
public class NioReceiveServer {
    ...
    //接受文件路径
    private static final String RECEIVE_PATH = "http:www.baidu.com"; // NioDemoConfig.SOCKET_RECEIVE_PATH;
    ...
    private ByteBuffer buffer = ByteBuffer.allocate(1024); //NioDemoConfig.SERVER_BUFFER_SIZE
